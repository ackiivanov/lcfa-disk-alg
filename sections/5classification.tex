...
\begin{observation}\label{obs:explore_D*}
    ...
    All of this is an elaboration of the fact that $\mathsf{D}_{0 \subset n}^*$ is equivalent to $\Delta^1 = \{0 \xrightarrow{} 1\}$ as $\infty$-categories (saying nothing about the right fibration to $\bsc$). Namely, the only nontrivial morphism is 
