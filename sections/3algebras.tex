...
\begin{proof}
    ...
    The equivalence of $\infty$-operads $\disk_{/M} \otimes \disk_{/N} \xrightarrow{\ \ \simeq \ \ } \disk_{/M \times N}$ implies and equivalence at the level of $\alg{\disk_{/M}}$, which together with \Cref{thm:disk_alg=lcfa} this the equivalence of factorization algebras of the statement. That this is related to the functor $\bar{\pi}$ can be seen by inspection of the objects and morphisms.
\end{proof}
