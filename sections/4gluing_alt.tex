...
\begin{proof}
    ...
    Using \Cref{thm:disk_alg=lcfa} and \Cref{cor:disk_alg=falg}, we will take the disk algebra incarnation of the relevant $\infty$-categories.
\end{proof}
...
This perspective on the theory of locally constant factorization algebras as a functor reframes the gluing result \Cref{thm:gluing_lcfas}, and together with lemma \Cref{lem:disk/M_to_disk} points towards a result like the following:
